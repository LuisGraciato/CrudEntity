Crud Feito usando Entity Framework, Cujo Objetivo era pegar dados de um cliente no banco de dados (SQL) e fazer as alterações (adicionar, remover, etc) por meio de requisições na web. Neste Projeto foi usado:
- API
- Requisições Http
- Uso de Interfaces
